...
class DataModule {
    ...
    @Provides
    @Singleton
    fun providesUserDataSource(appApi: AppApi, userDao: UserDao, sharedPreferences: PreferencesDataSource): UserDataSource =
            UserRepository(appApi, userDao, sharedPreferences)
